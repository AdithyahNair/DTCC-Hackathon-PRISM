  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const apiUrl = `httpss:/prism-backend-dtcc-dot-b/ock-cpnvey-p1.ur.r.ippsp-a.com-dtcc-dot-block-convey-p1.uc.r.appspot.com/ml/explainability/${projectId}/${modelId}/${model_version}`;
