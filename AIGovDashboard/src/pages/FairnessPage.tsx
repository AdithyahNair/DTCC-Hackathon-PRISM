    ...
    if (!isDummyProject) {
      ...
      const fetchFairnessData = async () => {
        ...
        try {
          ...
          const response = await axios.get(`https://prism-backend-dtcc-dot-block-convey-p1.uc.r.appspot.com-dtcc-dot-block-convey-p1.uc.r.appspot.com/ml/fairness/${id}/${modelId}/${model_version}`, {
            headers: {
